    ...
    [KOSessionTask userMeTaskWithCompletion:^(NSError *error, KOUserMe *me) {
        if (error) {
            ...
            if (displayResult) {
                ...
                if (me.account) {
                    ...
                    switch (me.account.ageRange) {
                        case KOUserAgeRangeNull:
                            if (me.account.ageRangeNeedsAgreement == YES) {
                                [message appendString:@"있음. (사용자 동의가 필요함)"];
                            } else {
                                [message appendString:@"없음"];
                            }
                    ...
                    [message appendString:@"\n출생 연도: "];
                    if (me.account.birthyear) {
                        [message appendString:me.account.birthyear];
                    } else if (me.account.birthyearNeedsAgreement == YES) {
                        [message appendString:@"있음. (사용자 동의가 필요함)"];
                    } else {
                        [message appendString:@"없음"];
                    }
                    ...
                    } else if (me.account.birthdayNeedsAgreement == YES) {
                        [message appendString:@"있음. (사용자 동의가 필요함)"];
                    } else {
                        [message appendString:@"없음"];
                    }
                    ...
                    switch (me.account.gender) {
                        case KOUserGenderNull:
                            if (me.account.genderNeedsAgreement == YES) {
                                [message appendString:@"있음. (사용자 동의가 필요함)"];
                            } else {
                                [message appendString:@"없음"];
                            }
                    ...
                    [message appendString:@"\nCI: "];
                    if (me.account.ci) {
                        [message appendString:me.account.ci];
                    } else if (me.account.ciNeedsAgreement == YES) {
                        [message appendString:@"있음. (사용자 동의가 필요함)"];
                    } else {
                        [message appendString:@"없음"];
                    }
                ...
                if ([me.account emailNeedsAgreement]) {
                ...
                if ([me.account phoneNumberNeedsAgreement]) {
                ...
                if ([me.account ageRangeNeedsAgreement]) {
                ...
                if ([me.account birthyearNeedsAgreement]) {
                    [needsAllScopes addObject:@"birthyear"];
                    [actions addObject:[UIAlertAction actionWithTitle:@"출생 연도 제공 동의 받기" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                        [self updateScopesAndRetryWithScopes:@[@"birthyear"]];
                    }]];
                }
                
                if ([me.account birthdayNeedsAgreement]) {
                ...
                if ([me.account genderNeedsAgreement]) {
                ...
                if ([me.account ciNeedsAgreement]) {
                    [needsAllScopes addObject:@"ci"];
                    [actions addObject:[UIAlertAction actionWithTitle:@"CI 제공 동의 받기" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                        [self updateScopesAndRetryWithScopes:@[@"ci"]];
                    }]];
                }

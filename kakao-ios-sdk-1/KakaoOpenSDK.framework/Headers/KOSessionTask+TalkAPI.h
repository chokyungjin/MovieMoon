 ...
 * @abstract 플러스 친구 목록 API 완료 핸들러
 * @param plusFriends 멤버 목록
 * @param error API 호출 도중 발생한 에러
 */
...
/*!
 @abstract 유저가 특정 플러스친구와 친구를 맺었는지 확인합니다.
 @param completionHandler 해당유저 플러스 친구의 목록 완료 핸들러. KOTalkPlusFriends 객체를 리턴한다.
...
/*!
 @abstract 유저가 특정 플러스친구와 친구를 맺었는지 확인합니다.
 @param publicIds 해당유저 플러스 친구의 public Id list.
 @param completionHandler 해당유저 플러스 친구의 목록 완료 핸들러. KOTalkPlusFriends 객체를 리턴한다.
 @seealso KOTalkPlusFriends
 */
